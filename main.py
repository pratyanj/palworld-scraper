...
class PalDetails:
    ...
    def extract_item_details(self, card, item_type,id,img:bool):
        ...
        item['image_github_url'] = f"https://raw.githubusercontent.com/pratyanj/palworld-scraper/main/images/{item_type}/{itemname}"
        ...
        if recipe_div:
            ...
            for row in recipe_rows:
                ...
                recipe_item['image_github_url'] = f"https://raw.githubusercontent.com/pratyanj/palworld-scraper/main/images/materials/{itemname}"
